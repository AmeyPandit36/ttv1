...
export const createSchemas:Record<string,z.ZodTypeAny>={
 academicYears:z.object({id,name:text.max(30),startsOn:z.string().default('2026-07-01'),endsOn:z.string().default('2027-06-30'),active:z.boolean().default(true)}),
 ...
 buildings:z.object({id,code:text.max(16),name:text,active:z.boolean().default(true)}),
 floors:z.object({id,name:text,ordinal:z.coerce.number().int(),buildingId:text})
};
